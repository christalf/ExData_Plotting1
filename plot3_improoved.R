...
## - Notice: instead of the two first arguments in all functions below, we can also
##           use the formula 'Sub_mettering_* ~ Time'.
## - Notice: instead of the "line()" function, we can also use the "point()"
